...
In this project, we'll delve deep on:
- React functional components and their reusability
- React file and folder structure
- We’ll use custom hooks and utility functions to manage the state of our application
- We’ll learn to create, compile and deploy your own smart contracts on the blockchain!
- We’ll achieve mastery using Tailwind and make the app responsive on all devices
- And most importantly, we’ll learn how to use Cranq, a graphical and intuitive IDE that’ll allow us to compile and deploy our smart contracts.

Links
- [Alchemy Faucet](https://goerlifaucet.com/)
- [Alchemy Faucet](https://goerlifaucet.com/)
- [Create Your ERC20 Tokens](https://goerlifaucet.com/)
